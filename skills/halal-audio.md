...
| `eleven_monolingual_v1` or `eleven_multilingual_v1` model ID in code throws 404 after July 9, 2026 | Both v1 models are removed July 9, 2026 (same day as scribe_v1) — **2 days away as of 2026-07-07** | Audit all scripts and configs for these model IDs NOW. Replace with `eleven_multilingual_v2` (same cost, same Dutch quality). Run `grep -r "monolingual_v1\|multilingual_v1\|scribe_v1" scripts/` immediately. |

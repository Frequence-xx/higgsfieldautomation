...
**Note (2026-08-29 pass 45 recheck):** MAI-Image-2.6 (#2 Arena T2I, +79 Elo over 2.5; also **#3 Arena image editing** — SC299 new finding) still NOT on AIMLAPI as of 2026-08-29 — AIMLAPI docs/product search returns only MAI-Image-2.5; no 2.6 page found. Available in MAI Playground, Microsoft Foundry, and Arena Direct Mode. Continue monitoring. Once confirmed, evaluate as upgrade path over MAI-Image-2.5 for brand stills AND character I2I edits (image editing rank confirmed). See ⟁² footnote below.
...
Need cheap B-roll scenery draft (no characters)? → Wan 2.7 Image Pro ($0.06, `alibaba/wan-2-7-image-pro`, 4K T2I, Dutch text support) — CANARY REQUIRED; Grok Imagine Image 2.0 (API open on OpenRouter/fal/Replicate since 2026-08-08, 3 refs via API, $0.04/img (1K) — NOT on AIMLAPI as of 2026-08-29 pass 45; monitor AIMLAPI) replaces the deprecated Quality model when it lands on AIMLAPI

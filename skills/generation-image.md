...
**🚨 IMAGEN 4 RETIREMENT — 2 DAYS AWAY (2026-06-22 update):** All three Imagen 4 variants (`imagen-4.0-ultra-generate-001`, `imagen-4.0-generate-001`, `imagen-4.0-fast-generate-001`) retire **June 24, 2026 — STOP ALL IMAGEN 4 CALLS NOW**. After June 24, all calls to `imagen-4.*` will return errors. Google's official replacement: `gemini-3-pro-image` = `google/nano-banana-pro` on AIMLAPI. Do NOT use Imagen 4 for any new jobs — use NBP Pro (`google/nano-banana-pro`, T2I) or NBP Edit (`google/nano-banana-pro-edit`, I2I with refs) for all remaining CTA/money-shot work. Gemini 2.5 Flash Image (`gemini-2.5-flash-image`) shuts down **October 2, 2026**.

...
**⚠️ FUTURE WATCH — Seedream 5.0 Full (2026-07-07 status: still NOT on AIMLAPI):** Full version features: native (non-upscaled) 4K output, **10-image reference blending** with locked consistency, Visual Chain-of-Thought spatial planning, direct pipeline to Seedance 2.0 video. Was described as "imminent" in May 2026 — it is now July 7 and still has not appeared on AIMLAPI. Only Seedream 5.0 Lite (`bytedance/seedream-5-0-lite-preview`) is confirmed. Expected AIMLAPI string when it lands: `bytedance/seedream-5-0-full` (monitor monthly). If 10-ref I2I lands on AIMLAPI, Seedream 5.0 Full becomes a cheaper NBP Edit fallback at potentially higher ref count.

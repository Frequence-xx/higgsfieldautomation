...
`alibaba/wan-2-7-r2v` is the Reference-to-Video mode of Wan 2.7. **As of 2026-07-06, Wan 2.7 R2V is NOT yet available on AIMLAPI** — listed as "Coming Soon" in the AIMLAPI model database. `docs.aimlapi.com` has a full page only for Wan 2.7 I2V (`alibaba/wan-2-7-i2v`); no R2V page yet. Wan 2.6 R2V (`alibaba/wan-2-6-r2v`) remains the only confirmed R2V on AIMLAPI. Wan 2.7 R2V is available on Segmind, Replicate, WaveSpeed, Together AI — all non-AIMLAPI providers. (re-confirmed 2026-07-06, pass 27)

...
| Kling v3 Standard I2V | `klingai/video-v3-standard-image-to-video` | 720x1280 (9:16) | **$0.546** ($0.1092/sec — SC350 2026-09-11 CONFIRMED; old $1.09 was 2.6× markup, now 1.3×) |
| Kling v3 Standard T2V | `klingai/video-v3-standard-text-to-video` | 720x1280 (9:16) | **$0.546** ($0.1092/sec — SC350 confirmed) |
| Kling v3 Pro I2V | `klingai/video-v3-pro-image-to-video` | **1080x1920 (9:16)** | **$0.728** ($0.1456/sec — search-confirmed from AIMLAPI pricing page SC360 Sept 14, 2026; audio canary still needed; old $1.46 was the 2.6× markup era, now 1.3×) |
| Kling v3 Pro T2V | `klingai/video-v3-pro-text-to-video` | **1080x1920 (9:16)** | **$0.728** ($0.1456/sec — search-confirmed SC360 Sept 14, 2026; audio canary still needed) |
...
**⚠️ PRICING OUTDATED — SC350 2026-09-11 SUPERSEDES:** The June 2026 "PRICING RESOLVED" note is WRONG as of September 2026. AIMLAPI Kling v3 Standard is now **$0.1092/sec = $0.546/5s** (confirmed SC350 — 3 independent sources: buildmvpfast.com AIMLAPI price table, AIMLAPI model page, explicit search result "Kling 3.0 Standard Image to Video is priced at $0.1092/sec through aimlapi"). AIMLAPI dropped Kling markup from ~2.6× to ~1.3× of native rates. Standard: $0.084/sec native × 1.3 = $0.109/sec ≈ $0.1092/sec. Pro: $0.1456/sec ($0.728/5s) — search-confirmed from AIMLAPI pricing page (SC360 Sept 14, 2026; AIMLAPI snippet: "$0.1456 per second (variable)"); audio behavior canary still needed for full pipeline confirmation. Market comp: fal.ai v3 Pro = $0.112/sec ($0.56/5s), fal.ai Turbo Pro = $0.14/sec ($0.70/5s) — AIMLAPI Pro lands at $0.1456/sec, confirmed above. The $1.09/5s and $1.46/5s figures in the original routing matrix are outdated and will cause 2× budget overestimation. See credit-efficiency.md for updated budget tables.

**Confirmed AIMLAPI Kling model roster (July 5, 2026):** Kling 2.6 Pro, Kling v3 Standard I2V, Kling v3 Standard T2V, Kling v3 Pro I2V, Kling v3 Pro T2V, **Kling v3 Standard Turbo I2V, Kling v3 Standard Turbo T2V, Kling v3 Turbo Pro I2V, Kling v3 Turbo Pro T2V** (all launched June 17, 2026 — canary required), Kling O1 Reference-to-Video, Kling O1 Video-to-Video Reference, Kling O1 Video-to-Video Edit, Kling 2.6 Pro Motion Control. **Also on AIMLAPI (NOT in routing matrix):** Kling v2 Master I2V/T2V and Kling v2.1 Master I2V/T2V (SC258 Aug 15, 2026 — found as dedicated docs.aimlapi.com pages; pricing ~$1.70/5s; more expensive than v3 Pro at $0.728 (SC360 confirmed) and older architecture — do NOT use for Snelverhuizen; v3 Pro is cheaper + higher resolution ceiling). **⚠️ RETIREMENT NOTICE (SC300 Aug 28, 2026):** Kling 1.0, 1.5, 1.6, 2.0 Master, 2.1, and 2.1 Master are confirmed retiring September 15, 2026 on the native Kling API — the v2 Master and v2.1 Master models listed here will be removed from AIMLAPI around the same date. These were already marked do-not-use; no pipeline impact since we use v3 Standard/Pro only. Kling 2.6 Pro is NOT in the retirement list — safe to use. **⚠️ RETIREMENT TOMORROW (as of Sept 14, 2026 — SC360 pass 48; SC353 pass 47 first flagged as 3 days):** Script audit SC339: zero legacy strings found in scripts/ or data/ — no action needed. No action needed for our v3 Standard/Pro pipeline. ⚠️ PRE-REMOVAL CONFIRMED (two-stage): (1) Kling v2 image model removed from ComfyUI partner node Aug 17, 2026 (PR #15676 merged — SC339 GitHub audit); (2) Kling v2 removed from Kling Image Generation (Kling's own native image-gen pipeline) ~Aug 28, 2026 (ComfyUI changelog — SC318). Full Sept 15 video API retirement proceeding on schedule. AIMLAPI-side: v2-master and v1.x docs pages still visible as of Sept 6, 2026 (SC332) — expected to be pulled on or after Sept 15. **NOT on AIMLAPI (confirmed absent Sept 8, 2026 — SC339 pass 45; GitHub api-docs audit Sept 6–8 shows ZERO Kling commits):** Kling O3/Omni (`klingai/video-v3-omni` base string — see dedicated O3 section below for full model strings confirmed in AIMLAPI model database SC279; no new O3 docs page added Aug-Sept 2026; site:docs.aimlapi.com search confirms no O3 page as of Sept 8, 2026), Kling v3 Motion Control Standard/Pro (only v2.6 confirmed on AIMLAPI; v3 Motion Control is live on WaveSpeedAI, Eachlabs, Replicate, MindStudio — but not AIMLAPI as of Sept 8, 2026 (SC339 pass 45 recheck)), Kling 4K (`klingai/video-o3-4k` — officially announced June 12, 2026; Runware-confirmed; AIMLAPI TBD since O3 itself lacks a dedicated docs page), **Kling 4.0** (announced Q3 2026 — "Lite, Fast, Standard, Pro & 4K tiers"; longer clips beyond 15s, 4K native, multi-shot sequencing, more than 6 shots per generation; still NOT released on any provider API as of Sept 14, 2026 (SC360 pass 48); Q3 2026 ends Sept 30 — 16 days remaining; no official announcement found (muapi.ai, morphic.com track it as "upcoming" with no confirmed dates); Q4 slip now highly probable; canary watch priority HIGH when it appears). **AIMLAPI Kling audit Sept 6–14, 2026 (SC339/SC346/SC353/SC360 pass 45-48):** Zero Kling-specific commits in AIMLAPI api-docs repo Sept 6-14, 2026 (GitHub commit audit). All Kling model strings, pricing, and parameters confirmed unchanged. Non-Kling additions Sept 11, 2026: sakana/fugu-ultra-v2, sakana/fugu-max, inclusionai/ling-3.0-flash-vl. Sept 13–14: zero new model additions (SC360 Github audit). Hidden Sept 10: deepseek/deepseek-v4.1-flash. Non-Kling additions Sept 9, 2026: openai/gpt-image-2.5-sunburst (Sept 9 — AIMLAPI string `openai/gpt-image-2.5-sunburst`; precision editing, 50% lower latency, same token pricing as GPT Image 2); openai/gpt-image-2.5-flare (Sept 9 — AIMLAPI string `openai/gpt-image-2.5-flare`; fast everyday generation variant); nvidia/nemotron-3.5-content-safety (Sept 9). Hidden Sept 9: nex-agi/nex-n2-pro, nex-agi/nex-n2-mini, kwaipilot/kat-coder-air-v2.5, ibm-granite/granite-4.1-8b, anthropic/claude-opus-4.8-fast. Non-Kling additions Sept 4-8: openai/gpt-6-astra (Sept 4); meta/muse-spark-1.3 (Sept 4). Previously noted: anthropic/claude-fable-5-1 (Sept 1), minimax/h3-max (Aug 31), arcee-ai/virtuoso-large (hidden), allenai/olmo-3-32b-think (hidden), Tencent HY4-Preview (LLM), Google Gemini Omni 1.1 Flash, Wan 3.0 Video.

**fal.ai naming note:** fal.ai renamed v3 endpoints to `o3` on April 10, 2026, then reversed back to `v3` on May 23, 2026. For v3 Pro on fal.ai, use `fal-ai/kling-video/v3/pro/image-to-video`. For O3/Omni on fal.ai, it's a separate model: `fal-ai/kling-video/o3/standard/image-to-video`. **Kling O3 is NOT on AIMLAPI as of September 8, 2026** — confirmed absent from AIMLAPI docs index (SC339 pass 45 recheck; no dedicated O3 page in site:docs.aimlapi.com Kling search results). The June 17, 2026 Turbo launch did NOT include O3/Omni on AIMLAPI — only the Turbo tier (Standard Turbo + Turbo Pro) was added. AIMLAPI's own blog post listing Kling models only mentions Kling 2.6 Pro and Kling v3 Pro. Also note: fal.ai Kling v3 Standard pricing ($0.084/sec) is ~1.3× cheaper than AIMLAPI ($0.1092/sec — SC350 confirmed) — the AIMLAPI-only mandate is a real but reduced cost penalty for Kling Standard tier (was ~2.6× before SC350 pricing correction).
...
## Elements (Subject Binding / Elements 3.0) — Exact AIMLAPI Structure

Pass reference images to keep a character's face consistent across clips.

**Kling's official branding for this system is "Elements 3.0"** (as of March 2026 launch). Externally described as "Subject Binding" — same system, two names. Claimed capabilities (SC265 Aug 17, 2026): identity stability through **0-180 degree head rotation** and **partial occlusion** (hands crossing face, hair over features, sunglasses, hats). Use `face_consistency: true` to activate the occlusion-recovery mechanism.
...
- **Top-level `duration` MUST EXACTLY EQUAL the sum of all shot durations.** The native Kling API enforces this as a hard constraint — e.g., 3 shots of 5s each → set top-level `"duration": "15"`. Passing a total that doesn't match will cause generation failure. (SC272 Aug 18, 2026)
- Each shot minimum duration: **1 second (native Kling API confirmed, SC272 Aug 18, 2026).** ~~SC244 discrepancy resolved~~: The 3-second minimum cited previously was a **Magnific API wrapper restriction only** — not the native Kling API constraint. Multiple independent sources confirm native minimum is >= 1 second. The 3s floor from fal.ai docs described fal.ai wrapper behavior, not the underlying API. For AIMLAPI specifically: minimum is unconfirmed — canary-test a 2-second shot before production use; use 3s as a conservative default until confirmed.
...
"duration": "15",     # MUST equal sum of all shot durations (5+5+5=15). Hard constraint.
...
## Kling O3 — IN AIMLAPI MODEL DATABASE, NO DEDICATED DOCS PAGE YET (SC318 pass 42 Sept 2, 2026)

Kling O3 (VIDEO 3.0 Omni, released Feb 5, 2026) is the premium tier above v3 Pro. **Status updated SC279 Aug 20, 2026: Kling O3/Omni NOW CONFIRMED in the AIMLAPI model database.** Prior study cycles (SC265 Aug 17, SC272 Aug 18) found no dedicated docs page — the models appear in the model database listing but may not yet have individual docs pages. **SC307 recheck (Aug 30, 2026):** No O3-specific commits in AIMLAPI api-docs repo during Aug 24-28, 2026 — status unchanged. **SC318 recheck (Sept 2, 2026):** Zero Kling commits in AIMLAPI api-docs repo Aug 31-Sept 1, 2026. site:docs.aimlapi.com search for Kling pages returns v1-standard, v1.6-standard, v2.6-pro, v3-standard, v1-pro — no O3/Omni page appears. Status: still model-database-only, no dedicated docs page. Canary remains the only path to verify live availability. The June 17, 2026 Turbo launch did NOT include O3/Omni; they were added to AIMLAPI subsequently (exact date TBD — first confirmed SC279).

...
| MAI-Image 2.5 Flash | `microsoft/mai-image-2.5-flash`⟁ (**NOT confirmed on AIMLAPI as of 2026-07-16 — monitor**) | Faster/cheaper variant of MAI-Image 2.5; same T2I + I2I; ~30% cheaper than full on output tokens (~$33/M vs $47/M); available on Azure AI Foundry + OpenRouter | TBD | token-based: $1.75/M text+image input / ~$33/M image output (~$0.03–0.10 est per img) | 9:16 supported |

...
| LTXV 2 Fast I2V | `ltxv/ltxv-2-fast` | 1080p | **$0.052/sec on AIMLAPI** (CONFIRMED, unchanged July 2026) | ⚠️ **URGENT: 19 days to Aug 15 deprecation (updated 2026-07-27, SC255).** LTX-2 deprecated July 15 — string now auto-routes to LTX-2.3 quality at same price. **String WILL ERROR after Aug 15 unless AIMLAPI adds `ltxv/ltxv-2-3-fast`.** No new AIMLAPI string found as of July 27. `generate_audio: false` confirmed working with LTX-2.3 routing. Hailuo 2.3 Fast ($0.0416/sec) is fallback if string errors. |

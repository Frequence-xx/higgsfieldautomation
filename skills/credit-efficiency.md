...
28. **Wan 2.7 R2V (`alibaba/wan-2-7-r2v`) is NOT confirmed on AIMLAPI as of 2026-06-19.** Listed as "Coming Soon" in AIMLAPI model database. `site:docs.aimlapi.com` search on June 19, 2026 returns only Wan 2.6 R2V page — NO Wan 2.7 R2V page. Use `alibaba/wan-2-6-r2v` for multi-ref character work requiring R2V. When Wan 2.7 R2V lands: parameters accept up to 5 mixed refs (images + video clips); characters referenced in prompt as `Image1`, `Image2`, `Video1` slot names.

...
| LTXV 2 Fast I2V | `ltxv/ltxv-2-fast` | 1080p | **$0.052/sec (was CONFIRMED)** | ❌ **BROKEN as of 2026-08-15.** Lightricks removed LTX-2 strings on Aug 15 — `ltxv/ltxv-2-fast` ERRORS on AIMLAPI. AIMLAPI never added replacement string as of SC262 (2026-08-16). Expected new string: `ltxv/ltxv-2-3-fast` (CANARY REQUIRED when/if AIMLAPI adds it). Use Hailuo 2.3 Fast ($0.0416/sec) for all non-char I2V. Watch: **LTX-2.5** released 2026-08-11 (open weights, 22B, I2V + T2V + audio; ltx-2-5-fast/pro on LTX native API) — **NOT on AIMLAPI as of SC343 2026-09-09** (confirmed by web search — no AIMLAPI model string found). |

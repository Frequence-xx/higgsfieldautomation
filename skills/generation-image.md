...
**Note (2026-09-04 pass 47 recheck — status unchanged):** MAI-Image-2.6 (#2 Arena T2I, +79 Elo over 2.5; also **#3 Arena image editing** — SC299 new finding) still NOT on AIMLAPI as of 2026-09-04 — AIMLAPI docs/product search returns only MAI-Image-2.5; no 2.6 page found. Available in MAI Playground, Microsoft Foundry Private Preview, and Arena Direct Mode. Continue monitoring. Once confirmed, evaluate as upgrade path over MAI-Image-2.5 for brand stills AND character I2I edits (image editing rank confirmed). See ⟁² footnote below.

⟁²**MAI-Image-2.6 (launched 2026-08-10 — NOT on AIMLAPI as of 2026-08-29 pass 45 recheck):** Microsoft's newest image generation model. Arena rankings: **#2 T2I (Elo 1336)** + **#3 image editing** (SC299 2026-08-28 — also confirmed ahead of Google NB family and Meta Muse Image on editing leaderboard) — beats NB2 (NB Pro), Meta Muse Image, and Grok Imagine Image 2.0; only GPT Image 2 ranks higher on T2I. Key improvements over MAI-Image-2.5: **+79 Elo overall**, **+91 Elo on text rendering specifically**, better portrait fidelity, 3D renders, and commercial product imagery. Reference image (I2I) support confirmed; same family as 2.5. **API rollout timeline:** consumer Arena access first; MAI Playground + Microsoft Foundry launched week of Aug 17, 2026. Third-party API providers (OpenRouter, etc.) expected shortly after Foundry launch. **NOT on AIMLAPI as of 2026-08-29 (pass 45 recheck) — AIMLAPI docs/product search shows no 2.6 page; monitor AIMLAPI for `microsoft/mai-image-2.6` addition.** When it lands: primary use case = highest-quality T2I/I2I for brand stills AND character editing (both leaderboards confirmed strong). Pricing: TBD (expected similar to or slightly above 2.5; canary required). 9:16 aspect ratio supported (same family convention as 2.5). **CANARY REQUIRED** before any production call once AIMLAPI adds it.

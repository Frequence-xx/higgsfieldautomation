...
FaceFusion **v3.8.2** is the current stable release (August 10, 2026; pass 44 recheck, 2026-08-25 — still latest, no new version). Previously v3.7.1 (July 5, 2026).

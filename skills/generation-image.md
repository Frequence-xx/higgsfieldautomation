...
## ⚠️ JUNE 25, 2026 — PREVIEW MODEL SHUTDOWN (15 days away as of 2026-06-10)
...
**4K output remains in Preview (GA status as of May 2026):** Google Cloud blog confirms 1K and 2K are GA-stable for both NBP and NB2. 4K output is still listed as Preview for both models. For production use, stick to 1K or 2K to avoid Preview-tier reliability risk.

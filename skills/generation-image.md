...
**⚠️ FUTURE WATCH — Seedream 5.0 Full (imminent as of 2026-07-05):** Full version features: native (non-upscaled) 4K output, **10-image reference blending** with locked consistency, Visual Chain-of-Thought spatial planning, direct pipeline to Seedance 2.0 video. NOT yet confirmed on AIMLAPI — expected string `bytedance/seedream-5-0-full` (monitor). If 10-ref I2I lands on AIMLAPI, Seedream 5.0 Full becomes a cheaper NBP Edit fallback at potentially higher ref count.

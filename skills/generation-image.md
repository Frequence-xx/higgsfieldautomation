...
| Grok Imagine Quality | `x-ai/grok-imagine-image-quality`† (**CANARY — Pro deprecated 2026-05-15**) | T2I + I2I; confirmed I2I edit endpoint; 3 refs; strong text; 14 aspect ratios incl. 9:16; 1K+2K | 3 | ~$0.055 (1K), ~$0.07 (2K) | 9:16 native |
...
†**Grok Imagine Image Quality (2026-06-20 update):** xAI launched `grok-imagine-image-quality` on 2026-05-06. Predecessor `grok-imagine-image-pro` deprecated **2026-05-15** — do not use. Supports T2I and confirmed I2I editing (xAI native edit endpoint confirmed live) with up to 3 reference images. 9:16 via `aspect_ratio: "9:16"` (confirmed). **Supported aspect ratios (14 total):** 1:1, 2:1, 1:2, 16:9, 9:16, 4:3, 3:4, 3:2, 2:3, 19.5:9, 9:19.5, 20:9, 9:20, auto. Resolutions: 1K and 2K. Strong text rendering and photorealism. Practical use: cheap B-roll / environment drafts ($0.055–$0.07) when character accuracy isn't required.

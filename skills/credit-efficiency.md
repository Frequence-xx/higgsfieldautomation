...
| Wan 2.7 R2V | `alibaba/wan-2-7-r2v` | 720p/1080p | ~$0.50 est. | **NOT CALLABLE — Coming Soon on AIMLAPI (corrected 2026-07-13, SC206).** SC199 "LIKELY LIVE" was wrong — model database entry ≠ callable. July 13 search: AIMLAPI docs still link to Wan 2.6 R2V page; no dedicated 2.7 R2V docs page found. DO NOT attempt to call. Wan 2.6 R2V (`alibaba/wan-2-6-r2v`) is live fallback. Parameters pre-confirmed: `image_urls` (max 3 image-only; ≤ 5 total mixed), `aspect_ratio: "9:16"`, duration 2-10s. |
...
| LTXV 2 Fast I2V | `ltxv/ltxv-2-fast` | 1080p | **$0.052/sec on AIMLAPI** (CONFIRMED 2026-06-14) | ⚠️ **DEPRECATION RISK (2026-07-13, SC206):** LTX native API deprecated `ltx-2-fast` on July 15, removal August 15, 2026. AIMLAPI has NOT added `ltxv-2-3-fast` yet. String may break by Aug 15. **DO NOT use for production shots until AIMLAPI confirms migration.** Use Hailuo 2.3 Fast ($0.0416/sec) as replacement for I2V shots. |
| LTXV 2 Standard I2V | `ltxv/ltxv-2` | 1080p | **$0.06/sec** ($0.36/6s min) | ⚠️ Same deprecation risk as LTXV 2 Fast — LTX-2 family removed August 15, 2026. Do not use until AIMLAPI migration confirmed. |
...
**Veo 3.1 Lite pricing update (2026-05-06, watch note 2026-07-11):** Resolution-tiered pricing confirmed. 720p: $0.05/sec (Vertex) → ~$0.065/sec on AIMLAPI (estimated, ~1.3× markup). 1080p: $0.08/sec (Vertex) → ~$0.104/sec on AIMLAPI (production-verified ✓). **Use 720p for B-roll drafts — saves ~37% vs 1080p.** Duration valid values: **4, 6, or 8 seconds ONLY** — 5 is invalid. 1080p requires duration=8. **WATCH (2026-07-11):** Multiple July 2026 sources cite $0.03/sec for Veo 3.1 Lite 720p without audio at Vertex — possibly a tiered rate for audio-off. If confirmed, AIMLAPI effective rate would drop to ~$0.039/sec = ~$0.195/5s. Run a canary and log actual AIMLAPI cost at next production use.

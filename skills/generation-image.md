...
| MAI-Image 2.5 Flash | `microsoft/mai-image-2.5-flash`⟁ (**NOT confirmed on AIMLAPI as of 2026-08-15 — monitor**) | Faster/cheaper variant of MAI-Image 2.5; same T2I + I2I; ~59% cheaper than full on image output (~$19.50/M vs $47/M confirmed); available on Azure AI Foundry + OpenRouter | TBD | token-based: $1.75/M text+image input / **$19.50/M image output** (~$0.02–0.07 est per img) | 9:16 supported |

...
**Confirmed AIMLAPI Kling model roster (July 5, 2026):** Kling 2.6 Pro, Kling v3 Standard I2V, Kling v3 Standard T2V, Kling v3 Pro I2V, Kling v3 Pro T2V, **Kling v3 Standard Turbo I2V, Kling v3 Standard Turbo T2V, Kling v3 Turbo Pro I2V, Kling v3 Turbo Pro T2V** (all launched June 17, 2026 — canary required), Kling O1 Reference-to-Video, Kling O1 Video-to-Video Reference, Kling O1 Video-to-Video Edit, Kling 2.6 Pro Motion Control. **Also on AIMLAPI (NOT in routing matrix):** Kling v2 Master I2V/T2V and Kling v2.1 Master I2V/T2V (SC258 Aug 15, 2026 — found as dedicated docs.aimlapi.com pages; pricing ~$1.70/5s; more expensive than v3 Pro at $1.46 and older architecture — do NOT use for Snelverhuizen; v3 Pro is cheaper + higher resolution ceiling). **NOT on AIMLAPI (confirmed absent August 17, 2026):** Kling O3/Omni (`klingai/video-v3-omni` — confirmed absent as of August 17, 2026 (SC265 recheck); the June 17 Turbo launch did NOT bring O3 to AIMLAPI; available on fal.ai, Replicate, Runware, Freepik, Wiro AI, Picsart), Kling v3 Motion Control Standard/Pro (only v2.6 confirmed on AIMLAPI; v3 Motion Control is live on WaveSpeedAI, Eachlabs, Replicate, MindStudio — but not AIMLAPI as of August 17, 2026 (SC265 recheck)), Kling 4K (`klingai/video-o3-4k` — officially announced June 12, 2026; Runware-confirmed; AIMLAPI TBD since O3 itself is absent).

**fal.ai naming note:** fal.ai renamed v3 endpoints to `o3` on April 10, 2026, then reversed back to `v3` on May 23, 2026. For v3 Pro on fal.ai, use `fal-ai/kling-video/v3/pro/image-to-video`. For O3/Omni on fal.ai, it's a separate model: `fal-ai/kling-video/o3/standard/image-to-video`. **Kling O3 is NOT on AIMLAPI as of August 17, 2026** — confirmed absent from AIMLAPI docs index (SC265 recheck). The June 17, 2026 Turbo launch did NOT include O3/Omni on AIMLAPI — only the Turbo tier (Standard Turbo + Turbo Pro) was added. AIMLAPI's own blog post listing Kling models only mentions Kling 2.6 Pro and Kling v3 Pro. Also note: fal.ai Kling v3 Standard pricing ($0.084/sec) is ~2.6× cheaper than AIMLAPI ($0.218/sec) — the AIMLAPI-only mandate is a real cost penalty for Kling Standard tier.
...
Kling O3 (VIDEO 3.0 Omni, released Feb 5, 2026) is the premium tier above v3 Pro. **Confirmed NOT on AIMLAPI as of August 17, 2026** — confirmed absent from AIMLAPI docs index and AIMLAPI's own blog post listing live Kling models (which lists only Kling 2.6 Pro and Kling v3 Pro, not O3). The June 17, 2026 Turbo launch did NOT include O3/Omni on AIMLAPI. A `site:docs.aimlapi.com` search for Kling models shows no O3/Omni page as of August 17, 2026 (SC265 recheck; prior SC258 Aug 15). O3 model string on Replicate: `kwaivgi/kling-v3-omni-video`; on fal.ai: `fal-ai/kling-video/o3/...`; expected AIMLAPI string when added: `klingai/video-v3-omni`. Available on fal.ai, Replicate, PiAPI, Atlas Cloud ($0.15/s), MindStudio, Vidguru, Picsart, Runware, and Freepik API — but **NOT AIMLAPI**. A 4K O3 variant (`klingai/video-o3-4k`, Runware-confirmed) was announced June 12, 2026 — expect both O3 base and O3 4K to land on AIMLAPI together. Farouq AIMLAPI-only directive means O3 cannot be used until it appears there.
